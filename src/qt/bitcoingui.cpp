    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("MinerOM Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a MinerOM address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and minerom: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About MinerOM Core"), this);
    aboutAction->setStatusTip(tr("Show information about MinerOM Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for MinerOM Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your MinerOM addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified MinerOM addresses"));
    ...
    openAction->setStatusTip(tr("Open a minerom: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the MinerOM Core help message to get a list with possible MinerOM Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("MinerOM Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to MinerOM network", "", count));
}
...
{
    QString strTitle = tr("MinerOM Core"); // default title
