    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("MinerOM-light"), QVariant("light"));
    ui->theme->addItem(QString("MinerOM-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("MinerOM-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("MinerOM-traditional"), QVariant("trad"));
