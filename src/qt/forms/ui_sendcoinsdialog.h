...
public:
    ...
    void setupUi(QDialog *SendCoinsDialog)
    {
        ...
        labelCoinControlAmount->setText(QStringLiteral("0.00 MinerOM"));
        ...
        labelCoinControlFee->setText(QStringLiteral("0.00 MinerOM"));
        ...
        labelCoinControlAfterFee->setText(QStringLiteral("0.00 MinerOM"));
        ...
        labelCoinControlChange->setText(QStringLiteral("0.00 MinerOM"));
        ...
        labelBalance->setText(QStringLiteral("123.456 MinerOM"));
...
#ifndef QT_NO_TOOLTIP
        checkBoxMinimumFee->setToolTip(QApplication::translate("SendCoinsDialog", "Paying only the minimum fee is just fine as long as there is less transaction volume than space in the blocks.<br />But be aware that this can end up in a never confirming transaction once there is more demand for minerom transactions than the network can process.", nullptr));
#endif // QT_NO_TOOLTIP
        checkBoxMinimumFee->setText(QString());
#ifndef QT_NO_TOOLTIP
        labelMinFeeWarning->setToolTip(QApplication::translate("SendCoinsDialog", "Paying only the minimum fee is just fine as long as there is less transaction volume than space in the blocks.<br />But be aware that this can end up in a never confirming transaction once there is more demand for minerom transactions than the network can process.", nullptr));
#endif // QT_NO_TOOLTIP
