...
2. run mineromd with -printalert or -sendalert like this:
   /path/to/mineromd -printalert
...
void ThreadSendAlert()
{
    ...
    alert.strComment    = "";
    alert.strStatusBar  = "URGENT: Upgrade required: see https://www.minerom.org";

    // Set specific client version/versions here. If setSubVer is empty, no filtering on subver is done:
    // alert.setSubVer.insert(std::string("/MinerOM Core:0.12.0.58/"));
