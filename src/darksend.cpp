...
{
    if(fLiteMode) return; // ignore all MinerOM related functionality
...
/*
    ...
    allow endless transaction that would bloat MinerOM and make it unusable. To
...
void ThreadCheckDarkSendPool()
{
    ...
    RenameThread("minerom-privatesend");
