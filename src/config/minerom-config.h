/* src/config/minerom-config.h.  Generated from minerom-config.h.in by configure.  */
/* src/config/minerom-config.h.in.  Generated from configure.ac by autoheader.  */
...
#define PACKAGE_BUGREPORT "https://github.com/worldmint/MinerOM/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "MinerOM Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "MinerOM Core 0.12.1"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "mineromcore"
