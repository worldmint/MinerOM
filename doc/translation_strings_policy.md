...
This document provides guidelines for internationalization of the MinerOM Core software.
...
This adds `<numerusform>`s to the respective `.ts` file, which can be translated separately depending on the language. In English, this is simply:
    ...
    <message numerus="yes">
        ...
        <translation>
            <numerusform>%n active connection to MinerOM network</numerusform>
            <numerusform>%n active connections to MinerOM network</numerusform>
        </translation>
    </message>
