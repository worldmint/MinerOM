...
MinerOM Core is a multithreaded application, and deadlocks or other multithreading bugs
...
However, in open source software such as MinerOM Core, where everyone uses
...
pay attention to for reviewers of MinerOM Core code.

General MinerOM Core
----------------------
...
- For `strprintf`, `LogPrint`, `LogPrintf` formatting characters don't need size specifiers
  ...
  - *Rationale*: MinerOM Core uses tinyformat, which is type safe. Leave them out to avoid confusion
