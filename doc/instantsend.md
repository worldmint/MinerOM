...
This mechanism has been integrated into Bitcore-Node-MinerOM which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/worldmint/insight-api-minerom#web-socket-api](https://github.com/worldmint/insight-api-minerom#web-socket-api) 
* API: [https://github.com/worldmint/insight-api-minerom#instantsend-transactions](https://github.com/worldmint/insight-api-minerom#instantsend-transactions) 
...
By default, the MinerOM Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the MinerOM Core daemon:
